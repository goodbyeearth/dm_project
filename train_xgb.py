...
train_address = "/home/train_10w.txt"

df=pd.read_table(train_address, header=None,delim_whitespace=True)
...
'''
nclf = RandomizedSearchCV(xgb_model, parameters, n_jobs=5, 
                   cv=3, 
                   scoring='roc_auc')
...
f = open('/home/testFeature/model_pickle', mode='wb')
pickle.dump(clf, f)
f.close()
print("auc={:.5f}\n".format(test_auc))
